...
const ChatWindow = () => {
    ...
    }, [setCurrentConversation, setHistory, setMessages]);
  ...
  useEffect(() => {
    ...
    const onAddConversation = async () => {
        ...
        try {
            ...
            const newConversation = await conversationService.createConversation(user._id, title);
        ...
        onClick: async (menuInfo) => {
            ...
            switch (menuInfo.key) {
                ...
                case 'delete':
                    ...
                    break;
                default:
                    console.log('Unhandled menu action:', menuInfo.key);
                    break;
            }
        },
    });
